...
function Readar() {
    ...
    wget -q --no-check-certificate --content-disposition 'http://readarr.servarr.com/v1/update/develop/updatefile?os=linux&runtime=netcore&arch=x64'
...
function Radarr() {
    ...
    wget -q --no-check-certificate --content-disposition 'http://radarr.servarr.com/v1/update/master/updatefile?os=linux&runtime=netcore&arch=x64'
    echo "Extract Radarr"
...
function Sonarr() {
    ...
    wget -q --no-check-certificate --content-disposition 'http://services.sonarr.tv/v1/download/master/latest?version=4&os=linux&runtime=netcore&arch=x64'
    echo "Extract Sonarr"
...
function Lidarr() {
    ...
    wget -q --no-check-certificate --content-disposition 'http://lidarr.servarr.com/v1/update/master/updatefile?os=linux&runtime=netcore&arch=x64'
    echo "Extract Lidarr"
...
function Prowlarr() {
    ...
    wget -q --no-check-certificate --content-disposition 'http://prowlarr.servarr.com/v1/update/master/updatefile?os=linux&runtime=netcore&arch=x64'
